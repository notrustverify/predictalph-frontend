      ...
      <div className={styles.grid}>
        <form onSubmit={bidSubmit}>
          <>
            ...
            <p>Price locked: ${(Number(roundStates?.priceStart) / intPriceDivision).toString()} ({(Number(price)-(Number(roundStates?.priceStart) / intPriceDivision)/(Number(roundStates?.priceStart) / intPriceDivision))*100}%)</p>
            <p>
              Round end at:{' '}
